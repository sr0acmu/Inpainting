...
class TestOptions :
    ...
    def initialize (self) :
        ...
        self.parser.add_argument ('--test_dir', type=str, default='./Testing3/bicubic_1', help="directory where all images are stored")
        ...
        self.parser.add_argument ('--base_dir', type=str, default='Testing3')
        self.parser.add_argument ('--pretrained_model_dir', type=str, default='pretrained_models/custom', help='pretrained model are provided here')
        self.parser.add_argument ('--checkpoint_prefix', type=str, default='ckpt-200')

        self.parser.add_argument ('--random_mask', type=int, default=2, help='0 -> Center 128 * 128 mask, 1 -> random mask, 2 -> grid mask')
        self.parser.add_argument ('--random_mask_type', type=str, default='grid_mask', help='options - irregular_mask, grid_mask and random_rect')
    ...
    def parse (self) :
        ...
        assert self.opt.random_mask in [0, 1, 2]
        assert self.opt.random_mask_type in ['irregular_mask', 'random_rect', 'grid_mask']
        ...
        self.opt.model_folder += '_center_mask' if self.opt.random_mask == 0 else '_grid_mask' if self.opt.random_mask == 2  else '_random_mask'
