...
parser.add_argument('--output_folder', type=str, default='eg/res', help="output image path")
parser.add_argument('--checkpoint', type=str, default='outputs/celeba-hq-regular/checkpoints/latest_G.pth',
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        for index, test_data in enumerate(test_loader):
            ...
            #saved_mask = (var_mask.cpu().numpy()).astype(np.uint8)
