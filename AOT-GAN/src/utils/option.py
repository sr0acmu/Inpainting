...
# data specifications 
parser.add_argument('--dir_image', type=str, default='./eg/celeba5',
                    help='image dataset directory')
parser.add_argument('--dir_mask', type=str, default='./eg/celeba5_m',
...
parser.add_argument('--image_size', type=int, default=60,
...
parser.add_argument('--pre_train', type=str, default='./models/G1000000.pt',
